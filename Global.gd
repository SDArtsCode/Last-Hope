...
var blueprints: Dictionary = {
	...
	"name": "Energy Sword", "has_blueprint": true, "cost": [5, 2, 3, 0, 0], "description": "Slices through enemies like... concrete"},
	...
	# modules
	"flashlight": {"stats": {"type": "flashlight"}, "name": "Flashlight Module", "has_blueprint": false, "cost": [5, 1, 2, 0, 0], "description": "Lights your way at night"},
	"night_vision": {"stats": {"type": "night_vision"}, "name": "Night Vision Module", "has_blueprint": false, "cost": [10, 2, 5, 2, 1], "description": "Allows the user to see more at night"},
	"scraper": {"stats": {"type": "scraper"}, "name": "Scraper Module", "has_blueprint": false, "cost": [30, 0, 2, 4, 1], "description": "Increases scrap dropped by 50%"},
	"jump": {"stats": {"type": "jump"}, "name": "Jump Leg Module", "has_blueprint": false, "cost": [10, 2, 2, 0, 0], "description": "Allows the user to jump"},
	"dash": {"stats": {"type": "dash"}, "name": "Dash Leg Module", "has_blueprint": false, "cost": [15, 1, 2, 0, 0], "description": "Allows the user to dash"},
	...
	"speed": {"stats": {"type": "upgrade", "effect": 100, "baseval": 200, "max": 3}, "name": "Speed", "has_blueprint": true, "cost": [10, 2, 2, 0, 0], "description": "Increases movement speed, with no cost to battery"},
